...
class DemoMap extends Component {
  ...
  onDeleteMarker = placeName => {
    this.props.deleteDemoPlace(placeName)
...
const mapDispatchToProps = dispatch => ({
  getDemoPlaces: () => dispatch(getDemoPlacesThunk()),
  addDemoPlace: place => dispatch(addDemoPlaceThunk(place)),
  deleteDemoPlace: place => dispatch(deleteDemoPlaceThunk(place))
})
